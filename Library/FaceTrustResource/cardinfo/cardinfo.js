...
//                               .replace(/月0(\d)日/g, '月 $1日');
        document.getElementById("cardinfo-expire").innerHTML = htmlEscape(data['cardinfo-expire'] + "まで有効");
    }
...
//     .replace(/(\D)(\d)日/g, '$1 $2日');
     document.getElementById("cardinfo-birth").innerHTML = data['cardinfo-birth'] + '生';
